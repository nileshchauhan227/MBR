...
{
    public partial class rptDetailSalesReport : Form
    {
        public DateTime dtFromDate;
        public DateTime dtToDate;
        public rptDetailSalesReport()
        {
            InitializeComponent();
            DefaultProperty();
        }
        public rptDetailSalesReport(DateTime? FromDate, DateTime? Todate)
        {
            InitializeComponent();
            DefaultProperty();
        ...
        private void rptDetailSalesReport_Load(object sender, EventArgs e)
        {
            LoadReport();
        }
        private void LoadReport()
        {
            ...
            DataSet ds = clsBReports.Reports("DetailSalesReport", dtFromDate, dtToDate);
