...
{
    public partial class rptStockBalance : Form
    {
        ...
        public rptStockBalance(DateTime? FromDate, DateTime? Todate)
        {
            InitializeComponent();
            this.WindowState = FormWindowState.Maximized;
            this.MinimizeBox = true;
        ...
        private void rptStockBalance_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dsRutu.GetStockBalance' table. You can move, or remove it, as needed.
            //this.GetStockBalanceTableAdapter.Fill(this.dsRutu.GetStockBalance);
            LoadReport();
        }
        private void LoadReport()
        {
            DataSet ds = clsBReports.Reports("GetStockBalance", dtFromDate, dtToDate);
