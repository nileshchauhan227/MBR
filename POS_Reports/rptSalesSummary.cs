...
{
    public partial class rptSalesSummary : Form
    {
        ...
        public rptSalesSummary(DateTime? FromDate, DateTime? Todate)
        {
            InitializeComponent();
            this.WindowState = FormWindowState.Maximized;
            this.MinimizeBox = true;
        ...
        private void rptSalesSummary_Load(object sender, EventArgs e)
        {
            LoadReport();
        }
        private void LoadReport()
        {
            DataSet ds = clsBReports.Reports("SalesSummary", dtFromDate, dtToDate);
