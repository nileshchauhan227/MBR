...
{
    public partial class rptInvoiceWiseSalesSummary : Form
    {
        public DateTime dtFromDate;
        public DateTime dtToDate;
        public rptInvoiceWiseSalesSummary()
        {
            InitializeComponent();
        }
        public rptInvoiceWiseSalesSummary(DateTime? FromDate, DateTime? Todate)
        {
            InitializeComponent();
            ...
            rptDetailSalesReport obj = new rptDetailSalesReport();
            obj.DefaultProperty();
            dtFromDate = FromDate.HasValue ? FromDate.Value : FromDate.Value;
            dtToDate = Todate.HasValue ? Todate.Value : Todate.Value;
        }

        private void rptInvoiceWiseSalesSummary_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dsRutu.InvoiceWiseSalesSummary' table. You can move, or remove it, as needed.
            //this.invoiceWiseSalesSummaryTableAdapter.Fill(this.dsRutu.InvoiceWiseSalesSummary);//
        ...
        {
            DataSet ds = clsBReports.Reports("InvoiceWiseSalesSummary", dtFromDate, dtToDate);
