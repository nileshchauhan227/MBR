...
{
    public partial class rptItemwSaleswiseReport : Form
    {
        public DateTime dtFromDate;
        public DateTime dtToDate;
        public rptItemwSaleswiseReport()
        {
            InitializeComponent();
        ...
        public rptItemwSaleswiseReport(DateTime? FromDate, DateTime? Todate)
        {
            InitializeComponent();
            this.WindowState = FormWindowState.Maximized;
            this.MinimizeBox = true;
        ...
        private void rptItemwSaleswiseReport_Load(object sender, EventArgs e)
        {
            LoadReport();
        }
