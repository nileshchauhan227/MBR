...
{
    public partial class rptSalesDetails : Form
    {
         
        public DateTime dtFromDate;
        public DateTime dtToDate;
        
        public rptSalesDetails()
        {
            InitializeComponent();
            DefaultProperty();
        }
        public rptSalesDetails(DateTime? FromDate, DateTime? Todate)
        {
            InitializeComponent();
            DefaultProperty();
        ...
        private void rptSalesDetails_Load(object sender, EventArgs e)
        {
