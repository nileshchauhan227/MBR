...
namespace POS.Classes
{
    public class PrintReceipt
    {
        ...
        {
            string printer = clsBConfiguration.GetConfigVal("DefaultPrinterForKOT");
        ...
        public void CreateReceipt(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int startY = 10;
            int offset = 40;
            graphic.DrawString("        RUTU               ", new Font("Courier New", 18), new SolidBrush(Color.Black), startX, startY);
