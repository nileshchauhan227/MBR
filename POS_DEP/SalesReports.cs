...
namespace POS
{
    public partial class SalesReports : Form
    {
        ...
        private void ShowReport(String str)
        {
            ...
            if (rdStockBalance.Checked == true)
            {
                POS_Reports.rptStockBalance rptStockBalance = new POS_Reports.rptStockBalance(dtFromDate.Value, dtToDate.Value);
                if (str.ToLower() == "show")
                    rptStockBalance.Show();
                else if (str.ToLower() == "pdf")
                    rptStockBalance.SavePDF();
                else if (str.ToLower() == "print")
                    rptStockBalance.PrintReport();
        ...
        private void rdStockBalance_CheckedChanged(object sender, EventArgs e)
        {
